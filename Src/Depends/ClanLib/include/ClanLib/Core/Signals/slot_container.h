...
public:
	...
	{
		_slots.push_back(sig.connect(func));
	}
	...
	{
		_slots.push_back(sig.connect(self, func));
	}
	...
	{
		_slots.push_back(sig.connect(func, user_data));
	}
	...
	{
		_slots.push_back(sig.connect(self, func, user_data));
	}
	...
	{
		_slots.push_back(sig.connect_functor(functor));
	}

private:
	std::vector<CL_Slot> _slots;
/// \}
};
